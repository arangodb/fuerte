...
template <>
ConOption::ConOption<std::string> ( const std::string &name, const std::string &value )
...
//
// IMPORTANT
// Value object only holds a pointer to a std::string object,  so a copy is required
//
template <>
