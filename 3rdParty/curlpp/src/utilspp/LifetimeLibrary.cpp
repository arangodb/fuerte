...
utilspp::LifetimeLibraryImpl::LifetimeLibraryImpl()
    : mTrackerArray(NULL), mNbElements(0) {}

utilspp::LifetimeLibraryImpl::~LifetimeLibraryImpl() { terminate(); }

void utilspp::LifetimeLibraryImpl::add(
    utilspp::PrivateMembers::LifetimeTracker* tracker) {
  utilspp::PrivateMembers::TrackerArray newArray =
  ...
  utilspp::PrivateMembers::TrackerArray pos =
      std::upper_bound(mTrackerArray, mTrackerArray + mNbElements, tracker,
                       &utilspp::PrivateMembers::LifetimeTracker::compare);
  std::copy_backward(pos, mTrackerArray + mNbElements,
...
void utilspp::LifetimeLibraryImpl::terminate() {
  ...
  while (mNbElements > 0) {
    ...
    mTrackerArray = static_cast<utilspp::PrivateMembers::TrackerArray>(
...
unsigned int utilspp::getLongevity(utilspp::LifetimeLibraryImpl*) { return 0; }
